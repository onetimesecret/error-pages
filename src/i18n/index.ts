...
const messages = {
  en: {
    ...
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'We have been experienceing a Denial of Service attack since the early morning on Sep 9, 2024 (PDT). More information is posted on our blog.',
  ...
  es: {
    ...
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Actualmente estamos realizando un mantenimiento programado. Volveremos en breve.',
  ...
  fr: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'Maintenance du Site',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Nous effectuons actuellement une maintenance programmée. Nous devrions être de retour sous peu.',
  ...
  de: {
    logoAlt: 'Onetime Secret Logo',
    title: 'Error Page',
    maintenanceTitle: 'Website Wartung',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Wir führen gerade eine geplante Wartung durch. Bitte versuchen Sie es später erneut.',
  ...
  nl: {
    ...
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'We zijn momenteel bezig met een gepland onderhoud. We zullen snel terug zijn.',
  ...
  bg: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'Профилактика на сайта',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'В момента извършваме планирана профилактика. Моля, опитайте отново по-късно.',
  ...
  fr_CA:
  {
    logoAlt: 'Logo Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Entretien du site web',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Nous effectuons actuellement une maintenance planifiée. Veuillez revenir dans quelques instants.',
  ...
  fr_CH:
  {
    ...
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Nous effectuons actuellement une maintenance planifiée. Veuillez revenir plus tard.',
    estimatedTime: 'Durée estimée',
  ...
  hi:
  {
    logoAlt: 'Onetime Secret Logo',
    title: 'Error Page',
    maintenanceTitle: 'साइट मेंटेनेंस',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'हम नियमित रखरखाव कर रहे हैं. कृपया थोड़ी देर बाद फिर से जांचें.',
  ...
  zh:
  {
    logoAlt: 'Onetime Secret Logo',
    title: 'Error Page',
    maintenanceTitle: '网站维护',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: '我们正在进行定期维护。请稍后再次访问。',
    estimatedTime: '预计时间',
    thankYou: '感谢您的耐心',
  ...
  ja:
  {
    logoAlt: 'Onetime Secret Logo',
    title: 'Error Page',
    maintenanceTitle: 'サイトメンテナンス',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: '定期メンテナンスを行っています。もう少しお待ちください。',
  ...
  pt: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'Manutenção do Site',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Estamos a realizar uma manutenção programada. Por favor, volte mais tarde.',
  ...
  pt_BR: {
    ...
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Estamos realizando uma manutenção programada. Por favor, volte mais tarde.',
    estimatedTime: 'Tempo estimado',
    thankYou: 'Obrigado pela sua paciência.',
  ...
  ru: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'Техническое обслуживание сайта',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Мы проводим плановое техническое обслуживание. Пожалуйста, вернитесь позже.',
  ...
  ar: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'صيانة الموقع',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'نحن نقوم حاليًا بأعمال الصيانة المجدولة. يرجى العودة لاحقًا.',
  ...
  ko: {
    ...
    title: 'Error Page',
    maintenanceTitle: '사이트 유지 보수',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: '정기적인 유지 보수를 진행 중입니다. 잠시 후에 다시 방문해 주십시오.',
    estimatedTime: '예상 시간',
  ...
  it: {
    logoAlt: 'Logo Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Manutenzione del sito',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Stiamo eseguendo la manutenzione pianificata. Per favore, ritorna più tardi.',
  ...
  tr: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'Site Bakımı',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Planlı bakım işlemi đang. Lütfen daha sonra tekrar deneyin.',
  ...
  pl: {
    logoAlt: 'Logo Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Konserwacja strony',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Przeprowadzamy planowaną konserwację. Proszę spróbuj ponownie później.',
  ...
  sv: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'Webbplatsunderhåll',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Vi utför planerat underhåll. Var vänlig och försök igen senare.',
  ...
  el: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'Συντήρηση Ιστοσελίδας',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Εκτελούμε προγραμματισμένη συντήρηση. Παρακαλώ δοκιμάστε ξανά αργότερα.',
  ...
  vi: {
    logoAlt: 'Logo Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Bảo trì trang web',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Chúng tôi đang thực hiện bảo trì theo lịch trình. Vui lòng thử lại sau.',
  ...
  th: {
    ...
    title: 'Error Page',
    maintenanceTitle: 'การบำรุงรักษาเว็บไซต์',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'เรากำลังดำเนินการบำรุงรักษาตามแผน โปรดลองอีกครั้งภายหลัง',
  ...
  id: {
    logoAlt: 'Logo Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Pemeliharaan Situs',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Kami sedang melakukan pemeliharaan terjadwal. Silakan coba lagi nanti.',
  ...
  uk: {
    logoAlt: 'Логотип Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Технічне обслуговування сайту',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Ми проводимо планове технічне обслуговування. Будь ласка, спробуйте знову пізніше.',
  ...
  ro: {
    logoAlt: 'Logo Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Întreținerea site-ului',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Suntem în curs de a efectua întreținerea planificată. Vă rugăm să încercați din nou mai târziu.',
  ...
  ms: {
    logoAlt: 'Logo Onetime Secret',
    title: 'Error Page',
    maintenanceTitle: 'Penyelenggaraan Laman',
    message: 'We are currently experiencing a server error. Please check back later.',
    maintenanceMessage: 'We are currently undergoing scheduled maintenance. Please check back later.',
    ddosMessage: 'Kami sedang melakukan penyelenggaraan terjadwal. Sila cuba lagi kemudian.',
